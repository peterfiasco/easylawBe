...
export const sendBusinessRegistrationConfirmation = async (userEmail, userName, serviceDetails) => {
  try {
...
export const sendDueDiligenceConfirmation = async (userEmail, userName, serviceDetails) => {
  try {
...
export const sendIPProtectionConfirmation = async (userEmail, userName, serviceDetails) => {
  try {
...
export const sendServiceProgressUpdate = async (userEmail, userName, updateDetails) => {
  try {
...
export const sendServiceCompletionEmail = async (userEmail, userName, completionDetails) => {
  try {
