...
const BusinessServiceSchema = new mongoose_1.Schema({
    user_id: {
...
BusinessServiceSchema.statics.generateReferenceNumber = function (serviceType) {
...
// Update the export
exports.default = mongoose_1.default.model('BusinessService', BusinessServiceSchema);
