...
exports.BusinessServicesController = void 0;
...
class BusinessServicesController {
    // Submit business registration request
    static submitBusinessRegistration(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { user_id } = req.user;
                const { clientInfo, businessDetails, directors, shareholders, priority, additionalRequirements } = req.body;
                // Validate required fields
                if (!clientInfo || !businessDetails || !directors || !shareholders) {
                    return (0, response_1.errorResponse)(res, "Missing required fields", { error: "All sections must be completed" }, 400);
                }
                ...
                const referenceNumber = BusinessService_1.default.generateReferenceNumber('business_registration');
                ...
                const businessService = new BusinessService_1.default({
                    user_id,
                ...
                yield businessService.save();
                // Send confirmation email
                try {
                    yield (0, email_service_1.sendBusinessServiceStatusUpdate)(clientInfo.email, clientInfo.fullName, {
    ...
    static submitDueDiligence(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { user_id } = req.user;
                const { clientInfo, investigationDetails, priority, additionalRequirements } = req.body;
                // Validate required fields
                if (!clientInfo || !investigationDetails) {
                    return (0, response_1.errorResponse)(res, "Missing required fields", { error: "Client info and investigation details are required" }, 400);
                }
                ...
                const amount = baseAmount * (priorityMultiplier[priority] || 1);
                // Generate reference number
                const referenceNumber = BusinessService_1.default.generateReferenceNumber('due_diligence');
                // Calculate estimated completion
                const estimatedDays = {
                    'standard': 5,
                    'express': 3,
                ...
                const dueDiligenceService = new BusinessService_1.default({
                    user_id,
                ...
                yield dueDiligenceService.save();
                // Send confirmation email
                try {
                    yield (0, email_service_1.sendBusinessServiceStatusUpdate)(clientInfo.email, clientInfo.fullName, {
                ...
                return (0, response_1.successResponse)(res, "Due diligence investigation request submitted successfully", {
                    reference_number: referenceNumber,
                    amount: amount,
    ...
    static getUserServices(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { user_id } = req.user;
                ...
                return (0, response_1.successResponse)(res, "User business services retrieved successfully", {
    ...
    static getServiceStatus(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { referenceNumber } = req.params;
                const { user_id } = req.user;
                if (!referenceNumber) {
                    return (0, response_1.errorResponse)(res, "Reference number is required", {}, 400);
                }
                // Find service by reference number and user
                const service = yield BusinessService_1.default.findOne({
                    reference_number: referenceNumber,
                    user_id
                })
                    ...
                    .lean();
                if (!service) {
                    return (0, response_1.errorResponse)(res, "Service not found", { error: "No service found with this reference number" }, 404);
                }
                ...
                return (0, response_1.successResponse)(res, "Service details retrieved successfully", serviceDetails, 200);
            }
            catch (error) {
    ...
    static submitBusinessService(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                const { user_id } = req.user;
                const _b = req.body, { registration_type, business_name, priority = 'standard', new_business_name, reason_for_change, new_address, annual_returns_year, current_address, new_authorized_capital, capital_increase_reason } = _b, otherData = __rest(_b, ["registration_type", "business_name", "priority", "new_business_name", "reason_for_change", "new_address", "annual_returns_year", "current_address", "new_authorized_capital", "capital_increase_reason"]);
                ...
                const amount = ((_a = servicePricing[registration_type]) === null || _a === void 0 ? void 0 : _a[priority]) || 50000;
                const referenceNumber = BusinessService_1.default.generateReferenceNumber('business_service');
                ...
                const businessService = new BusinessService_1.default({
                    ...
                    additional_requirements: JSON.stringify(Object.assign({ registration_type,
                        new_business_name,
                        reason_for_change,
                        new_address,
                        annual_returns_year,
                        ...
                        capital_increase_reason }, otherData))
                });
                yield businessService.save();
                return (0, response_1.successResponse)(res, "Business service request submitted successfully", {
                    reference_number: referenceNumber,
                    amount: amount,
                    service_id: businessService._id
                }, 201);
    ...
    static getPricing(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const pricingRecords = yield BusinessServicePricing_1.default.find({ is_active: true })
                ...
                return (0, response_1.successResponse)(res, "Pricing retrieved successfully", groupedPricing, 200);
            }
            catch (error) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!service_id || !transaction_id) {
                    return (0, response_1.errorResponse)(res, "Missing required fields", { error: "Service ID and transaction ID are required" }, 400);
                }
                // Find and update the service
                const service = yield BusinessService_1.default.findOneAndUpdate({ _id: service_id, user_id }, {
                ...
                return (0, response_1.successResponse)(res, "Payment status updated successfully", {
                    reference_number: service.reference_number,
                    status: service.status,
                    payment_status: service.payment_status
                }, 200);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!['submitted', 'pending'].includes(service.status)) {
                    return (0, response_1.errorResponse)(res, "Service cannot be cancelled", { error: "Service is already being processed" }, 400);
                }
                ...
                return (0, response_1.successResponse)(res, "Service cancelled successfully", {}, 200);
            }
            catch (error) {
...
exports.BusinessServicesController = BusinessServicesController;
