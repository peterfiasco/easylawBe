...
exports.AdminBusinessServicesController = void 0;
const response_1 = require("../../utils/response");
const BusinessService_1 = __importDefault(require("../../models/BusinessService"));
const email_service_1 = require("../../services/email.service");
const BusinessServicePricing_1 = __importDefault(require("../../models/BusinessServicePricing"));
class AdminBusinessServicesController {
    // Get all business services with filtering and pagination
    static getAllServices(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { status, service_type, priority, payment_status, search, limit = 20, page = 1, sort_by = 'createdAt', sort_order = 'desc' } = req.query;
                // Build query
                const query = {};
                ...
                // Fetch services
                const services = yield BusinessService_1.default.find(query)
                    ...
                    .lean();
                // Get total count
                const totalServices = yield BusinessService_1.default.countDocuments(query);
                ...
                const formattedServices = services.map(service => {
                    ...
                    return ({
                        ...
                        documents_count: ((_a = service.documents) === null || _a === void 0 ? void 0 : _a.length) || 0,
                        created_at: service.createdAt,
                        last_updated: service.last_updated
                    });
                });
                // Get summary statistics
                const stats = yield BusinessService_1.default.aggregate([
                    { $match: query },
                    {
                        $group: {
                            _id: null,
                ...
                return (0, response_1.successResponse)(res, "Business services retrieved successfully", {
    ...
    static getServiceDetails(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { referenceNumber } = req.params;
                // ✅ FIX: Use BusinessService model (consistent with getAllServices)
                const service = yield BusinessService_1.default.findOne({ reference_number: referenceNumber })
                ...
                return (0, response_1.successResponse)(res, "Service details retrieved successfully", service, 200);
            }
            catch (error) {
    ...
    static updateServiceStatus(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { referenceNumber } = req.params;
                ...
                if (!status) {
                    return (0, response_1.errorResponse)(res, "Status is required", { error: "Status field is required" }, 400);
                }
                ...
                const service = yield BusinessService_1.default.findOneAndUpdate({ reference_number: referenceNumber }, Object.assign({ status, last_updated: new Date() }, (status === 'completed' && { actual_completion: new Date() })), { new: true, runValidators: true }).populate('user_id', 'first_name last_name email');
                if (!service) {
                    return (0, response_1.errorResponse)(res, "Service not found", { error: `No service found with reference number: ${referenceNumber}` }, 404);
                }
                ...
                return (0, response_1.successResponse)(res, "Service status updated successfully", {
                    reference_number: service.reference_number,
                    status: service.status,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!name || !type || !url || !download_url) {
                    return (0, response_1.errorResponse)(res, "Missing required document fields", { error: "Document name, type, url, and download_url are required" }, 400);
                }
                const service = yield BusinessService_1.default.findOne({ reference_number: referenceNumber });
                if (!service) {
                    return (0, response_1.errorResponse)(res, "Service not found", {}, 404);
                ...
                try {
                    yield (0, email_service_1.sendBusinessServiceStatusUpdate)(service.client_email, service.client_name, {
                ...
                return (0, response_1.successResponse)(res, "Document added successfully", {
                    reference_number: service.reference_number,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (service.status === 'completed') {
                    return (0, response_1.errorResponse)(res, "Cannot delete completed service", { error: "Completed services cannot be deleted" }, 400);
                }
                // Delete the service
                yield BusinessService_1.default.findOneAndDelete({ reference_number: referenceNumber });
                return (0, response_1.successResponse)(res, "Service deleted successfully", {}, 200);
            }
            catch (error) {
    ...
    static getAnalytics(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const analytics = yield BusinessService_1.default.aggregate([
                    { $match: matchQuery },
                    {
                        $group: {
                            _id: null,
                ...
                const serviceTypeBreakdown = yield BusinessService_1.default.aggregate([
                    { $match: matchQuery },
                    {
                        $group: {
                            _id: "$service_type",
                ...
                const dailyTrends = yield BusinessService_1.default.aggregate([
                    { $match: matchQuery },
                    {
                        $group: {
                            _id: {
                ...
                const priorityBreakdown = yield BusinessService_1.default.aggregate([
                    { $match: matchQuery },
                    {
                        $group: {
                            _id: "$priority",
                ...
                return (0, response_1.successResponse)(res, "Analytics retrieved successfully", {
                    summary: analytics[0] || {
                        total_services: 0,
                        total_revenue: 0,
                        avg_service_value: 0,
    ...
    static getRevenueAnalytics(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const revenueByServiceType = yield BusinessService_1.default.aggregate([
                    {
                        $match: {
                            createdAt: { $gte: startDate, $lte: endDate },
                            payment_status: 'paid'
                ...
                // Daily revenue trend
                const dailyRevenue = yield BusinessService_1.default.aggregate([
                    {
                        $match: {
                            createdAt: { $gte: startDate, $lte: endDate },
                            payment_status: 'paid'
                ...
                const monthlyRevenue = yield BusinessService_1.default.aggregate([
                    {
                        $match: {
                            payment_status: 'paid'
                        }
                ...
                // Revenue summary
                const revenueSummary = yield BusinessService_1.default.aggregate([
                    {
                        $match: {
                            createdAt: { $gte: startDate, $lte: endDate }
                        }
                ...
                return (0, response_1.successResponse)(res, "Revenue analytics retrieved successfully", {
    ...
    static getPerformanceAnalytics(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const completionAnalytics = yield BusinessService_1.default.aggregate([
                    {
                        $match: {
                            createdAt: { $gte: startDate, $lte: endDate }
                        }
                ...
                const processingTimeByType = yield BusinessService_1.default.aggregate([
                    {
                        $match: {
                            createdAt: { $gte: startDate, $lte: endDate },
                ...
                const staffPerformance = yield BusinessService_1.default.aggregate([
                    {
                        $match: {
                            createdAt: { $gte: startDate, $lte: endDate },
                ...
                const qualityMetrics = yield BusinessService_1.default.aggregate([
                    {
                        $match: {
                            createdAt: { $gte: startDate, $lte: endDate },
                ...
                const weeklyTrend = yield BusinessService_1.default.aggregate([
                    {
                        $match: {
                            createdAt: { $gte: startDate, $lte: endDate }
                        }
                ...
                return (0, response_1.successResponse)(res, "Performance analytics retrieved successfully", {
    ...
    static getAllStaff(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return (0, response_1.successResponse)(res, "Staff list retrieved successfully", formattedStaff, 200);
            }
            catch (error) {
    ...
    static assignStaff(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { referenceNumber } = req.params;
                const { staff_id, notes } = req.body;
                if (!staff_id) {
                    return (0, response_1.errorResponse)(res, "Staff ID is required", {}, 400);
                }
                // Verify staff exists and has appropriate role
                const User = require('../../models/User').default;
                const staff = yield User.findById(staff_id);
                if (!staff || !['admin', 'staff'].includes(staff.role)) {
                    return (0, response_1.errorResponse)(res, "Invalid staff member", {}, 400);
                }
                // Update service with assigned staff
                const updatedService = yield BusinessService_1.default.findOneAndUpdate({ reference_number: referenceNumber }, {
                    assigned_staff: staff_id,
                    internal_notes: notes ? `Staff assigned: ${notes}` : `Assigned to ${staff.first_name} ${staff.last_name}`,
                    updated_at: new Date()
                }, { new: true }).populate('assigned_staff', 'first_name last_name email');
                if (!updatedService) {
                    return (0, response_1.errorResponse)(res, "Service not found", {}, 404);
                }
                ...
                try {
                    ...
                    yield sendBusinessServiceAssignmentEmail(staff.email, `${staff.first_name} ${staff.last_name}`, updatedService.service_type, referenceNumber, updatedService.client_name || 'Unknown Client');
                }
                catch (emailError) {
                    console.error('Failed to send assignment email:', emailError);
                    // Don't fail the assignment if email fails
                }
                return (0, response_1.successResponse)(res, "Staff assigned successfully", {
    ...
    static getAllPricing(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const pricing = yield BusinessServicePricing_1.default.find({ is_active: true })
                    .populate('created_by', 'first_name last_name email')
                    .populate('updated_by', 'first_name last_name email')
                    .sort({ service_type: 1, priority: 1 });
                console.log('📊 Found pricing records:', pricing.length);
                return (0, response_1.successResponse)(res, "Pricing configurations retrieved successfully", pricing, 200);
            }
            catch (error) {
    ...
    static createPricing(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (existingPricing) {
                    return (0, response_1.errorResponse)(res, "Pricing configuration already exists", { error: "A pricing configuration for this service type and priority already exists" }, 400);
                }
                // Create new pricing
    ...
    static updatePricing(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const pricing = yield BusinessServicePricing_1.default.findOne({
                ...
                pricing.updated_by = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id;
                yield pricing.save();
...
exports.AdminBusinessServicesController = AdminBusinessServicesController;
